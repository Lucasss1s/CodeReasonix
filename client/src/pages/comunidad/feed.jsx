        ...
        <div className="delete-overlay">
          <div className="delete-modal">
            ...
            <div className="delete-modal-preview">
              <div className="delete-modal-author">
                <strong>
                  {publicacionAEliminar.cliente?.usuario?.nombre || "Usuario"}
                </strong>
                <span className="delete-modal-fecha">
                  {" • "}
                  {formatFecha(publicacionAEliminar.fecha)}
                </span>
              </div>
              <div className="delete-modal-texto">
                {publicacionAEliminar.contenido?.slice(0, 140) ||
                  "Publicación sin contenido"}
                {publicacionAEliminar.contenido &&
                  publicacionAEliminar.contenido.length > 140 &&
                  "…"}
              </div>
            </div>
